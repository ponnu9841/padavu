        ...
        <div className="container flex justify-between items-center">
          <Link href="/" className="text-2xl font-bold">
            <NextImage
              ...
              className="aspect-[3/1] w-50 md:w-70 max-h-35"
            />
          </Link>
          <NavigationMenu />
        </div>
        ...
        <div className="my-4 flex flex-wrap justify-between">
          <div>
            ...
            <div className="mt-3 flex gap-3">
              <Link
                href="https://www.instagram.com/padavuinterio"
                target="_blank"
              >
                <NextImage
              ...
              <Link href="https://www.facebook.com/share/1Fwwus7FB9" target="_blank">
                <NextImage
              ...
              <Link href="https://www.youtube.com/@padavuinterio" target="_blank">
                <NextImage
