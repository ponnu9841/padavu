...
export const getBlogResponseById = async (id: string): Promise<Blog | null> => {
   try {
...
export const getPagesBannersResponse = () =>
   fetchData<PagesBanner[]>("/pagesBanner");
...
export const getClientsResponse = () => fetchData<ClientsResponse>("/clients");
export const getWorksResponse = () => fetchData<WorksResponse>("/works");
export const getTestimonialsResponse = () =>
   fetchData<Testimonial[]>("/testimonials");
